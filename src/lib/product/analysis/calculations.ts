 ...
 *
 * Part of the PRODUCT layer -- this is fintech domain logic.
 */
...
export const THRESHOLDS = {
  ...
  MAX_MONETARY_VALUE: 100_000_000,
...
export function calculateMetrics(data: FinancialData): FinancialMetrics {
  ...
  return { savingsRate, netWorth, emergencyFundMonths, debtToIncomeRatio, monthlySavings };
}
